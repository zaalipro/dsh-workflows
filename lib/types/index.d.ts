...
export declare const version = "0.1.0-rc.10";
...
export declare const HOST_COMPATIBILITY: Readonly<{
    ...
    versions: readonly ["0.1.6-alpha.1"];
    evaluator: "plugin-compat-engine-v1";
}>;
type InstalledHostVersions = readonly [host: unknown, workflow: unknown];
export declare function isSupportedHostVersion(value: unknown): value is '0.1.6-alpha.1';
