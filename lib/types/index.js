...
export function isCompatibleHost(ctx) {
    try {
...
export async function apply(ctx, input = {}) {
    ...
    if (!compatible) {
        const log = optionalProperty(ctx, 'logger');
    ...
    try {
        ...
        resources.skill = asCleanup(registerTrustedWorkflowSkillSync(ctx, { required: compatible }));
