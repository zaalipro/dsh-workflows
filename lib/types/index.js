...
export const HOST_COMPATIBILITY = Object.freeze({
    ...
    versions: Object.freeze(['0.1.2-rc.1']),
    evaluator: 'plugin-compat-engine-v1',
});
const INCOMPATIBLE_MESSAGE = '@zaalipro/dsh-workflows 0.1.0-rc.5 supports exactly official DeepSeek Harness 0.1.2-rc.1';
...
async function createCompatibilityEngine(ctx, config) {
    ...
    if (subagents === undefined || typeof optionalProperty(subagents, 'getProvider') !== 'function'
        ...
        throw new WorkflowPackageError('official DeepSeek Harness 0.1.2-rc.1 requires the subagents service for plugin workflows', 'WORKFLOW_INCOMPATIBLE_HOST');
    }
