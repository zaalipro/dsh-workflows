...
const WORKFLOW_NAME_RULE = 'expected 1–64 UTF-16 code units, lowercase kebab-case beginning with a letter, excluding reserved command and Windows device names';
/**
 ...
 */
export function isWorkflowDefinitionName(value) {
 ...
 */
export function assertWorkflowDefinitionName(value, source) {
...
function renderRejectedValue(value) {
    if (value === null)
        return 'null';
    switch (typeof value) {
