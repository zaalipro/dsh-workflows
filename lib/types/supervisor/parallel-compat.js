...
export const SCHEMA_STRIP_PRELUDE = 'agent = (function (hostAgent) {'
    ...
    + 'if (opts == null || typeof opts !== "object" || opts.schema == null) return opts;'
    + 'var next = {};'
    + 'var optKeys = Object.keys(opts);'
    + 'for (var j = 0; j < optKeys.length; j++) next[optKeys[j]] = opts[optKeys[j]];'
    + 'next.schema = stripSchema(opts.schema);'
    + 'return next;'
    + '}'
...
export function scriptWithJobMapParallel(script) {
