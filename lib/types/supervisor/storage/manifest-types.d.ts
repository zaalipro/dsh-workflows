...
export type WorkflowCompletionNoticeState = {
    ...
    readonly lane: 'followup' | 'inject';
} | {
    readonly state: 'abandoned';
    readonly finalizedAt: number;
    readonly reason: 'process-lost' | 'owner-disposed' | 'enqueue-failed' | 'teardown';
    readonly claimId?: string;
    readonly processEpoch?: string;
    readonly claimedAt?: number;
    readonly error?: WorkflowRunManifestText;
};
export type WorkflowCompletionNoticeFinalization = {
    ...
    readonly claimedAt: number;
    readonly finalizedAt: number;
    readonly reason: 'owner-disposed' | 'enqueue-failed' | 'teardown';
    readonly error?: string;
};
export interface WorkflowRunDetailReferenceV2 {
    readonly id: string;
...
export interface WorkflowRunMemberDetail {
    ...
    readonly status: WorkflowMemberStatus;
...
export interface WorkflowRunLogDetail {
    readonly index: number;
    readonly text: string;
}
export interface WorkflowRunDetailPayloadV2 {
    readonly members?: readonly WorkflowRunMemberDetail[];
    readonly logs?: readonly WorkflowRunLogDetail[];
    readonly result?: {
        readonly state: WorkflowRunOutcomeState;
        readonly value?: JsonValue;
...
export interface WorkflowRunDetailSnapshotV2 {
    readonly version: 2;
    ...
    readonly snapshotRevision: number;
    readonly payload: WorkflowRunDetailPayloadV2;
}
...
export interface WorkflowRunHeadRecord {
    ...
    readonly error?: string;
    readonly phase?: string;
    readonly terminalPreview?: string;
    readonly budget: {
        readonly total: number;
    ...
    readonly detail: WorkflowRunDetailReferenceV2;
    ...
    readonly completionNotice: WorkflowCompletionNoticeState;
    readonly executionAvailable?: boolean;
    readonly scriptPath?: string;
    readonly saveAvailable?: boolean;
    readonly allowedActions?: readonly string[];
}
export interface WorkflowSessionManifest {
    readonly version: 2;
    readonly sessionId: string;
    readonly revision: number;
    ...
    readonly heads: readonly WorkflowRunHeadRecord[];
}
...
export interface RecoveredRun extends WorkflowRunHeadRecord {
