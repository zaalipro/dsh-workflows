...
/*
 * Stock 0.1.5-rc.1 predates the opaque contribution marker and atomic
...
export function installWorkflowShadow(agent, servicesOrTool) {
    ...
    // Stock 0.1.5-rc.1: the ToolRuntime and SystemPrompt public APIs scope a
...
/**
 * Published 0.1.5-rc.1 has resolve/lstat/processPath/readBytes but not the
