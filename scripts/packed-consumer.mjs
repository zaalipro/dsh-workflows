...
try {
  ...
  await command('pnpm', [
    ...
    'typescript@5.9.3', '@types/node@22.20.1', '@deepseek-ai/dsh@0.1.5-rc.1',
  ...
  if (installedManifest.version !== '0.1.0-rc.6'
    ...
    || JSON.stringify(installedManifest.dsh?.compatibility?.versions) !== JSON.stringify(['0.1.5-rc.1'])) {
  ...
  if (officialManifest.version !== '0.1.5-rc.1') throw new Error(`official Harness 0.1.5-rc.1 is required, got ${String(officialManifest.version)}`)
