...
export const WORKFLOW_SCOPE_PRECEDENCE = ['bundled', 'project', 'user'] as const satisfies readonly WorkflowScope[];
...
export interface RegistryConfig { readonly enabled?: boolean; readonly dshHome?: string; readonly bundledDefinitionsDir?: string; readonly definitionWatch?: boolean; readonly definitionMaxBytes?: number; readonly maxDefinitionsPerRoot?: number; readonly watchMaxProjects?: number; readonly watchUsePolling?: boolean; readonly watchStabilityThresholdMs?: number; readonly watchPollIntervalMs?: number }
