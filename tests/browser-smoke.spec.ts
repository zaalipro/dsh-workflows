  ...
  it.skipIf(!releaseTarball || !officialCheckout)(
    ...
    async () => {
      ...
      try {
        ...
        const bundle = await fetch(new URL('/plugins/@zaalipro/dsh-workflows/client.js', readiness.url), { headers })
        ...
        const sourceMap = await fetch(new URL('/plugins/@zaalipro/dsh-workflows/client.js.map', readiness.url), { headers })
